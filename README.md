...
> [!CAUTION]
> Проект находится в активной стадии разработки. На данный момент нет ни одной скомпилированной сборки для демонстрации работы комплекса инструментов. 
...
_Если Вы хотите помочь с проектом, то напишите мне на эту почту: `collab@dmitriykotik.ru`, если же у Вас возникли вопросы по проекту, то напишите на эту почту: `support@dmitriykotik.ru`, ну, а если хотите купить мне кофе, то можете отправить денежку [**сюда**](https://www.donationalerts.com/r/dmitryy090209). Спасибо! <3_

_Это **не** форк проекта `GoldbergEmu`! `PleaseRetry` - самостоятельный проект, который не связан с `GoldbergEmu`._
